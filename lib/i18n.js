    ...
    constructor() {
        ...
        this.translations = {
            en: {
                ...
                'style.rich': 'Rich',
                'micro-break-enabled': 'Enable micro-break reminders',
                'micro-break-interval': 'Micro-break interval (minutes)',
                'tts-end-time-enabled': 'Speak end time (TTS)',
            ...
            vi: {
                ...
                'notification-style': 'Kiểu thông báo',
                'style.compact': 'Gọn nhẹ',
                'style.rich': 'Đầy đủ',
                'micro-break-enabled': 'Bật nhắc giải lao ngắn',
                'micro-break-interval': 'Khoảng thời gian giải lao (phút)',
                'tts-end-time-enabled': 'Đọc lên khi hết giờ (TTS)',
